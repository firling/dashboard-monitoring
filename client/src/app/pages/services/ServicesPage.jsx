...
const ServicesPage = () => {
    ...
    const remove = (id) => {
        axios.delete('http://localhost:3000/services', {data: {id}})
            .then(res => {
                getServices();
            })
    }
    ...
    return (
        <>
                                            ...
                                            <tr>
                                                    ...
                                                    <div className='d-flex align-items-center'>
                                                        <div className='symbol symbol-50 symbol-light mr-4'>
                                                            <span className='symbol-label'>
                                                                <img src='/media/svg/misc/terminal-svgrepo-com.svg' className='h-50 align-self-center' alt='' />
                                                            </span>
                                                        </div>
                                                        <div>
                                                            <p className='text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg'>{service.name}</p>
                                                ...
                                                <td>
                                                    <div className='d-flex'>
                                                        <a href='#' onClick={() => remove(service.id)} className='btn btn-icon btn-light btn-hover-danger btn-sm'>
                                                            <span className='svg-icon svg-icon-md svg-icon-primary'>
                                                                <i className="bi bi-trash"></i>
                                                            </span>
                                                        </a>
                                                        <a href='#' onClick={() => restart(service.id)} className='btn btn-icon btn-light btn-hover-danger btn-sm ms-5'>
                                                            <span className='svg-icon svg-icon-md svg-icon-primary'>
            ...
            <CreateService show={show} handleclose={() => setShow(false)} servers={servers} getServices={getServices} />
        </>
    )
}
